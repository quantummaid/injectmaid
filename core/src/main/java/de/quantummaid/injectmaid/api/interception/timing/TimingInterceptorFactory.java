...
import static de.quantummaid.injectmaid.api.interception.timing.TimingInterceptor.timingInterceptor;
...
public final class TimingInterceptorFactory implements InterceptorFactory {
    ...
    public static TimingInterceptorFactory timingInterceptorFactory(final Duration maxDuration) {
        validateNotNull(maxDuration, "maxDuration");
        return new TimingInterceptorFactory(maxDuration);
    }

    @Override
    public Interceptor createInterceptor() {
        return timingInterceptor(maxDuration);
    }
}
